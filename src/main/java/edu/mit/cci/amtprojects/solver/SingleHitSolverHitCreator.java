 ...
 * Time: 3:57 PM
 */
public class SingleHitSolverHitCreator implements HitCreator {


    private static SingleHitSolverHitCreator instance;

    private static String rankerpath;
    private static String generatorpath;
    private static String validationpath;

    private SingleHitSolverHitCreator() {

    }

    public static SingleHitSolverHitCreator getInstance() {
        if (instance == null) {
            instance = new SingleHitSolverHitCreator();
        }
        return instance;
    }
